...
export default function Footer() {
  ...
  useEffect(() => {
    // Khi chạy vô đấy -> Copy thẻ <script> khai báo trong HTML
    // Kiến thức Javascript DOM tái tạo lại một thẻ <script> bằng CODE
    ...
    scriptTag.setAttribute('nonce', 'aK38kwQL');
    scriptTag.src = 'https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v10.0&appId=294848405324259&autoLogAppEvents=1';
